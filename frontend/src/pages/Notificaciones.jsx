...
import Protegido from '../componentes/Protegido'; // ✅ Protección
...
const Notificaciones = () => {
  ...
  return (
    <Protegido modulo="notificaciones" accion="ver"> {/* ✅ Protegido */}
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <section className="mb-6 bg-white p-4 rounded shadow">
          ...
          {['recibidos', 'transito', 'entregados', 'pendientes', 'retraso'].map(key => (
                ...
                <tr key={i} className="hover:bg-gray-50">
                  ...
                  <td className="border px-3 py-2">
                    <span className={`px-2 py-1 rounded text-white text-xs font-semibold ${
                      n.tipo === 'Email' ? 'bg-blue-500' :
                      n.tipo === 'SMS' ? 'bg-purple-500' :
                      'bg-green-500'
                    }`}>{n.tipo}</span>
                  </td>
                  ...
                  <td className="border px-3 py-2">
                    <span className={`text-xs font-semibold px-2 py-1 rounded ${
                      n.estado === 'Enviado' ? 'bg-green-100 text-green-700' :
